    ...
    <nav class="navbar">
        <div class="nav-content">
            ...
            <div class="nav-links">
                ...
                <a href="/attachment-application" class="cta-button">Apply Now</a>
            </div>
        </div>
    </nav>
        ...
        <div class="features-content">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    ...
                    <p>Work alongside a diverse team and build connections that will help you in your career journey.</p>
                </div>
                <div class="feature-card">
                    <i class="fas fa-cogs"></i>
                    <h3>Hands-On Projects</h3>
                    <p>Take on real tasks and projects that make a difference, putting your skills to the test in a professional setting.</p>
                </div>
                <div class="feature-card">
